...
const requiredFiles = [
  ...
  'dist/dsh/model-auto/coordinator.js',
  'dist/dsh/model-auto/command.js',
  ...
  'docs/memory-application.md',
  'docs/auto-memory-review.md',
  'dist/dsh/lisp/manager.js',
  'dist/dsh/lisp/surface.js',
  'dist/dsh/lisp/worker.js',
  'dist/dsh/typesafe/client.js',
  'dist/dsh/typesafe/command.js',
  'dist/dsh/typesafe/contracts.js',
  'dist/dsh/typesafe/credentials.js',
  'docs/typesafe.md',
  'scripts/smoke-typesafe.mjs',
  'scripts/laya-worker.py',
  'scripts/smoke-laya-coreml.mjs',
  'docs/laya-coreml.md',
