...
export async function stageModules(output) {
  ...
  for (const name of Object.keys(entries)) {
    ...
    const assetFiles = name === 'core' ? [...migrations, 'docs/typed-decisions.md', 'docs/typesafe.md', 'PERMISSIONS.md'] : name === 'lisp' ? [...(await walk(join(root, 'lisp'))).map(file => `lisp/${file}`), 'docs/typesafe.md', 'docs/lisp.md', 'scripts/smoke-typesafe.mjs', 'PERMISSIONS.md'] : []
